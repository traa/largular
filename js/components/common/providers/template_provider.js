/**
* ALL CREDENTIALS TO CLEVERSTACK TEAM
* https://github.com/CleverStack/angular-seed/blob/master/app/modules/cs_common/providers/TemplateProvider.js
**/
...
define( [ 'angular', '../module' ], function( angular ) {
  ...
  .provider( 'Template', [
    function() {
       ...
       */
      var viewsPath = basePath + '/js/components/:moduleName/views/';
       ...
       */
      var partialsPath = viewsPath + '/js/components/:section/partials/';
